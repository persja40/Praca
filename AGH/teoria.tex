...
z(t) &= \frac{W_x(t+dt)-W_x(t)}{\Delta t} \nonumber\\
z(t) \Delta t &= W_x(t+dt)-W_x(t) = \Delta p_0 \nonumber\\
...
\begin{align*}
z(t) &= \frac{\dot{x}(t+\Delta t)-\dot{x}(t)}{\Delta t} \\
z(t) \Delta t &= \dot{x}(t+\Delta t)-\dot{x}(t) = \Delta p_0
\end{align*} 
